...
<Dialog>      
    ...
    <DialogHeader>
      ...
      <Input type="text" placeholder="Search" className="placholder:text-4xl text-4xl focus:text-black  p-4 w-full  rounded-md border h-12 focus:outline-none text-4xl my-4   bg-white/30 focus:bg-white"  />
